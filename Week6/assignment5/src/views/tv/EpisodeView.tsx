import { FaArrowLeft, FaCalendar, FaStar, FaTv } from "react-icons/fa";
import { Link, useParams } from "react-router-dom";
import ErrorMessage from "../components/ErrorMessage";
import Loading from "../components/Loading";
import { useFetch } from "../hooks/useTMDB";
import { getImageUrl, getSeasonDetails } from "../services/tmdbApi";
		...
		<div>
			...
			<div className="space-y-4">
				{data.episodes.map((episode) => (
					<div
						key={episode.id}
						className="bg-gray-800 rounded-xl overflow-hidden flex flex-col md:flex-row"
					>
						<img
