import { FaArrowLeft, FaCalendar, FaFilm, FaList } from "react-icons/fa";
import { Link, useParams } from "react-router-dom";
import ErrorMessage from "../components/ErrorMessage";
import Loading from "../components/Loading";
import { useFetch } from "../hooks/useTMDB";
import { getImageUrl, getSeasons } from "../services/tmdbApi";
					...
					>
						<div className="flex">
							...
							<div className="p-4 flex-1">
								<h3 className="text-xl font-bold group-hover:text-tmdb-light transition">
									{season.name}
								</h3>
