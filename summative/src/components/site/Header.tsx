    ...
    <header className="bg-tmdb-dark sticky top-0 z-50 shadow-lg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link to={currentUser ? '/home' : '/'} className="flex items-center gap-2 text-2xl font-bold text-tmdb-green">
            <FaFilm />
          ...
          {currentUser && (
            <nav className="hidden md:flex items-center gap-1">
              ...
              <Link to="/genre/movie" className={navLinkClass('/genre')}>
                <FaThLarge /> Genres
              </Link>
            </nav>
          )}
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-1 ml-2">
              ...
              {currentUser ? (
                ...
                <Link
                  to="/signin"
                  className="ml-2 flex items-center gap-2 px-3 py-1.5 text-sm text-gray-900 bg-tmdb-green rounded-full hover:bg-green-300 transition"
                >
                  <FaSignInAlt /> Sign In
                </Link>
              )}
